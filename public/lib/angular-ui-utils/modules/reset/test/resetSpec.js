...
describe('uiReset', function () {
  ...
  describe('compiling this directive', function () {
    it('should throw an error if we have no models defined', function () {
      function compile() {
    ...
    it('should proper DOM structure', function () {
      scope.foo = 'bar';
      scope.$digest();
      var element = $compile('<input type="text" ui-reset ng-models="foo"/>')(scope);
  ...
  describe('clicking on the created anchor tag', function () {
    ...
    it('should set the models value to null and clear control when no options given', function () {
      scope.foo = 'bar';
      var element = $compile('<input type="text" ui-reset ng-models="foo"/>')(scope);
      scope.$digest();
    ...
    it('should set the models value to the options scope variable when a string is passed in options', function () {
      scope.foo = 'bar';
      scope.resetTo = 'i was reset';
      var element = $compile('<input type="text" ui-reset="resetTo" ng-models="foo"/>')(scope);
      scope.$digest();
      expect(element.val()).toBe('bar');
      element.next().triggerHandler('click');
